...
VALORES PERMITIDOS:
- tipo: "jaleco", "scrub", "gorro", "dolma-avental", "robe", "macacao", "infantil", "nao-texteis", "outros" ou null
...
function analisarMensagemManual(mensagem, contexto) {
  ...
  const tiposPadroes = [
    { regex: /\b(jaleco)/i, tipo: 'jaleco' },
    { regex: /\b(scrub)/i, tipo: 'scrub' },
    { regex: /\b(gorro|gorros)/i, tipo: 'gorro' },
    { regex: /\b(dolma|dolmã|avental)/i, tipo: 'dolma-avental' },
    { regex: /\b(robe)/i, tipo: 'robe' },
    { regex: /\b(macacao|macacão)/i, tipo: 'macacao' },
    { regex: /\b(infantil)/i, tipo: 'infantil' }
  ];
